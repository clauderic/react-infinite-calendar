  ...
  Day.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      ...
      _extends({
        ...
        className: (0, _classnames2.default)(styles.root, (_classNames = {}, _classNames[styles.today] = isToday, _classNames[styles.highlighted] = isHighlighted, _classNames[styles.selected] = isSelected, _classNames[styles.disabled] = isDisabled, _classNames[styles.enabled] = !isDisabled, _classNames[styles.hasMonth] = showMonth, _classNames[styles.hasYear] = showYear, _classNames), className),
        onClick: this.handleClick,
        'data-date': date
      }, handlers),
      showMonth && _react2.default.createElement(
        'span',
        { className: styles.month },
        monthShort
      ),
