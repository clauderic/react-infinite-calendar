...
var Month = function (_Component) {
  ...
  Month.prototype.componentDidMount = function componentDidMount() {
    this.startMonth = (0, _format2.default)(this.props.monthDate, 'YYYY-MM-DD');
    this.endMonth = (0, _format2.default)((0, _end_of_month2.default)(this.props.monthDate), 'YYYY-MM-DD');
  };

  Month.prototype.shouldComponentUpdate = function shouldComponentUpdate(nextProps) {
    var nextSelected = nextProps.selected,
        nextRest = _objectWithoutProperties(nextProps, ['selected']);

    var _props = this.props,
        selected = _props.selected,
        rest = _objectWithoutProperties(_props, ['selected']);

    var selectedDaysOverlapMonth = nextSelected !== selected && (nextSelected.start <= this.endMonth && nextSelected.end >= this.startMonth || // Update month for next selection
    selected.start <= this.endMonth && selected.end >= this.startMonth // Update month for former selection
    );

    return !(0, _shallowEqual2.default)(nextRest, rest) || selectedDaysOverlapMonth;
  };
  ...
  Month.prototype.render = function render() {
    ...
    var _props3 = this.props,
        locale = _props3.locale.locale,
        monthDate = _props3.monthDate,
        today = _props3.today,
        rows = _props3.rows,
        rowHeight = _props3.rowHeight,
        showOverlay = _props3.showOverlay,
        style = _props3.style,
        theme = _props3.theme;
