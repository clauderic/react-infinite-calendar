...
var _withScrollLock = require('../utils/withScrollLock');

var _withScrollLock2 = _interopRequireDefault(_withScrollLock);
...
var ListWithScrollLock = (0, _withScrollLock2.default)(_reactTinyVirtualList2.default);
...
var MonthList = function (_Component) {
  ...
  MonthList.prototype.render = function render() {
    ...
    return _react2.default.createElement(ListWithScrollLock, {
      ref: this._getRef,
      width: width,
      height: height,
