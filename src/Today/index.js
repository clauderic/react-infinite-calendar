...
export default class Today extends Component {
	...
	render() {
		let {locale, show, theme} = this.props;
		return (
			<div className={classNames(style.root, {[style.show]: show, [style.chevronUp]: show === 1, [style.chevronDown]: show === -1})} style={{color: theme.floatingNav.color, backgroundColor: theme.floatingNav.background}} onClick={this.scrollToToday} ref="node">
