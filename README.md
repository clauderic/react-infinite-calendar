...
| showSelectionText | Boolean                                                | false                         | Wether to show the month or "Today" in the selected days selection.                                                                                                                                            |
| showTodayHelper      | Boolean                                                | false                                                                                                 | Show/hide the floating back to `Today` helper                                                                                                                                                                                               |
